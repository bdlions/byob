...
modules.threads = '2012-August-13';
...
Process.prototype.reportURL = function (url) {
    ...
    if (!this.httpRequest) {
        ...
        this.httpRequest.open("GET", 'http://' + url, false);
...
Process.prototype.reportIsA = function (thing, typeString) {
    return this.reportTypeOf(thing) === typeString;
};
...
Context.prototype.image = function () {
	...
	if (this.expression instanceof Morph) {
        ...
        // replace call/cc block with empty slot
        if (this.isContinuation) {
            cont = detect(block.allInputs(), function (inp) {
                return inp.selector === 'reportCallCC';
            });
            if (cont) {
