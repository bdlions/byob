...
/*
    return [
        new SymbolMorph('turtle', 50, new Color(250, 250, 0))
    ];
*/
/*
...
BlockMorph.prototype.showHelp = function () {
    ...
    pic.src = 'help/' + this.selector + '.png';
};
...
BlockMorph.prototype.eraseHoles = function (context) {
	...
	holes.forEach(function (hole) {
		var	w = hole.width(),
			h = hole.height() - 1; // Opera needs this
		context.clearRect(
			hole.bounds.origin.x - myself.bounds.origin.x,
			hole.bounds.origin.y - myself.bounds.origin.y,
			w,
			h
		);
	});
