...
HTMLCanvasElement, fontHeight, SymbolMorph*/

modules.widgets = '2012-August-14';
...
PushButtonMorph.prototype.fixLayout = function () {
	...
	if (this.label !== null) {
		...
		this.setExtent(new Point(
			...
			Math.max(this.label.height(), this.labelMinExtent.y) + padding
		));
...
ToggleMorph.prototype.hide = function () {
	this.isVisible = false;
	this.changed();
};

ToggleMorph.prototype.show = function () {
	this.isVisible = true;
	this.changed();
};
